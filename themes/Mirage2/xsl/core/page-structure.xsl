...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            ...
                            <div id="main-container" class="container">
                                ...
                                <div class="row row-offcanvas row-offcanvas-right" style="margin-right:0px;">
    ...
    <xsl:template name="buildHeader">
		...
		<div class="col-xs-12 col-md-12 col-sm-12" style="background-color:#003777;">
                        ...
                        <ul class="nav navbar-nav pull-left">
                            ...
                            dri:metadata[@element='identifier' and @qualifier='logoutURL']}">
                                ...
                                <xsl:otherwise>
                                    ...
                                    <li class="dropdown">
                                        <a id="collection-dropdown-toggle" href="#" role="button" class="dropdown-toggle"
                                           data-toggle="dropdown">
                                            <span class="hidden-xs">
                                                Collections
                                                <b class="caret"/>
                                        ...
                                        <ul class="dropdown-menu pull-right" role="menu"
                                            aria-labelledby="collection-dropdown-toggle" data-no-collapse="true">
                                            <li>
                                                <a href="#">
                                                    Text
                                                </a>
                                    ...
                                    <li>
                                        <a href="{$theme-path}images/LE_PROJET.pdf" target="_blank">
                                            <span class="hidden-xs">
                                                Le projet						
                                            </span>
                                        </a>
    ...
    <div class="col-xs-12 col-md-12 col-sm-12">
        <div class="navbar-header">
            ...
            <a href="{$context-path}/" class="navbar-brand">
                <!-- <img src="{$theme-path}/images/DSpace-logo-line.png" />-->
                <img src="{$theme-path}/images/logo14.jpg" style="padding-right:0px;"/>
            </a>
	    	<a href="{$context-path}/" class="navbar-brand">
...
<div id="ds-options2" class="word-break hidden-print">
                    	...
                    	<fieldset>
                        	<div class="input-group3">
                            	...
                            	<span class="input-group-btn">
                                	<button class="ds-button-field btn btn-primary1" title="xmlui.general.go" i18n:attr="title">
        ...
        <div class="navbar-header pull-right visible-xs hidden-sm hidden-md hidden-lg">
            <ul class="nav nav-pills pull-left ">
                ...
                <xsl:choose>
                    <xsl:when test="/dri:document/dri:meta/dri:userMeta/@authenticated = 'yes'">
                        <li class="dropdown">
                                    <button class="dropdown-toggle navbar-toggle navbar-link" id="user-dropdown-toggle-xs" href="#" role="button"  
                                    data-toggle="dropdown">
...
<!--BARRE DE RECHERCHE A COTE DE L'ACCUEIL -->
<!--
...
-->
	...
	<div class="row" style="margin-right:0px; margin-bottom:20px;">
		<div class="col-xs-12 col-sm-12 col-md-12" style="background-color:#003777; height:63px;">
		        <footer>
				
				<div class="col-xs-12 col-sm-12 col-md-12" style="text-align:center;">
					<div>
						<span style="font-family:'Times New Roman';color:white;">Bibliothèque Université Cheikh Anta Diop</span>
					</div>
					<div>
